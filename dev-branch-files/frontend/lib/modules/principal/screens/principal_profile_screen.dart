...
import '../widgets/data_display/profile_banner.dart';
import '../widgets/feedback/error_state.dart';
import '../widgets/feedback/loading_skeleton.dart';
...
import '../widgets/tabs/account_security_tab.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return TabbedPage(
            ...
            ProfileBanner(
              ...
              onSecondaryAction: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Export simulated (no backend yet).'),
                  ),
                );
              },
            ),
      ...
      tabs: const [
        ...
        PageTab(label: 'Account Security', content: AccountSecurityTab()),
      ],
    );
  }
}
