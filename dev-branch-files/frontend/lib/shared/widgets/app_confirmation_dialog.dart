...
class _AppConfirmationDialogState extends State<AppConfirmationDialog> {
  ...
  Widget build(BuildContext context) {
    final Color accentColor = widget.type == ConfirmationType.edit
        ? AppColors.info
        : widget.type == ConfirmationType.delete
            ? AppColors.error
            : AppColors.primary;

    final IconData iconData = widget.type == ConfirmationType.edit
        ? Icons.edit_note_rounded
        : widget.type == ConfirmationType.delete
            ? Icons.delete_forever_rounded
            : Icons.help_outline_rounded;

    final String actionNote = widget.type == ConfirmationType.delete
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(AppSpacing.borderRadiusMd),
                            borderSide: BorderSide(
                              color: _verified ? AppColors.success : accentColor,
                              width: 1.5,
                            ),
                          ),
